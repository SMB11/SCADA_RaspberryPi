...
labeling_timeout_value = tk.StringVar(value="5")  # Default timeout in seconds as string
...
def update_gui():
    ...
    try:
        traffic_threshold = int(traffic_threshold_value.get())
    except ValueError:
        traffic_threshold = 2  # Default value if input is invalid
